...
st = time()
mesh_numpy.ioo.write_obj_with_colors_texture(os.path.join(save_folder, 'numpy.obj'), vertices, triangles, colors, texture, uv_coords)
print('----------write obj numpy: ', time() - st)

st = time()
mesh.ioc.write_obj_with_colors_texture(os.path.join(save_folder, 'cython.obj'), vertices, triangles, colors, texture, uv_coords)
